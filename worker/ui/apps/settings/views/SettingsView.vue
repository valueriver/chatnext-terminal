...
.logout-btn {
    ...
    background: var(--panel); box-shadow: 0 6px 20px #0000000d;
    color: var(--bad); font-size: 14px; font-weight: 800; transition: background 0.15s;
}
.logout-btn:hover { background: var(--bad-soft); }
</style>
