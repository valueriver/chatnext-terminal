...
function openInTerminal() {
    if (!ws.connected || !files.cwd) return;
...
<template>
    <div class="shrink-0 border-b border-line bg-bg">
        ...
        <!-- Row 2: file actions -->
        <div class="flex flex-wrap items-center gap-1 px-3 py-2.5 border-t border-line">
            ...
            <button @click="files.refresh" class="tb-btn" :disabled="!ws.connected" title="刷新">
            ...
            <button @click="openInTerminal" class="tb-btn" :disabled="!ws.connected" title="在终端 cd 到此目录">
            ...
            <button @click="triggerUpload" class="tb-btn" :disabled="!ws.connected" title="上传到当前目录">
            ...
            <button @click="files.createFolder" class="tb-btn" :disabled="!ws.connected" title="新建目录">
            ...
            <button @click="files.createFile" class="tb-btn" :disabled="!ws.connected" title="新建空文件">
        ...
        <div class="flex flex-wrap items-center gap-x-0.5 gap-y-1 px-3 py-2 border-t border-line">
            <button @click="files.goUp" class="tb-btn-sm" :disabled="!ws.connected" title="上一级">
            ...
            <button @click="files.goHome" class="tb-btn-sm" :disabled="!ws.connected" title="主目录">
